  ...
  function (_Component) {
    ...
    function PatablesAsync(props) {
      ...
      _defineProperty(_assertThisInitialized(_this), "getVisibleData", function () {
        if (_this.props.searchParam && _this.props.searchParam.length === 2) {
          _this.setState({
            search: _this.props.searchParam[1]
          });
        }

        if (_this.props.pageParam && _this.props.pageParam.length === 2) {
          _this.setState({
            currentPage: _this.props.pageParam[1]
          });
        }

        if (_this.props.limitParam && _this.props.limitParam.length === 2) {
          _this.setState({
            resultSet: _this.props.limitParam[1]
          });
        }

        if (_this.props.orderByParam && _this.props.orderByParam.length === 2) {
          _this.setState({
            sortOrder: _this.props.orderByParam[1]
          });
        }
